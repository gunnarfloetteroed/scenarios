...
public class NetworkEditor {
	...
	public static void editNework() {
		...
		for (Link l : network.getLinks().values()) {
			...
			if (l.getId().toString().equals("213740") || l.getId().toString().equals("953710") || l.getId().toString().equals("953685")) {
				l.setCapacity(2000.0);
			...
			if (l.getId().toString().equals("450237") || l.getId().toString().equals("450205") || l.getId().toString().equals("1323371")) {
				l.setCapacity(1200.0);
				
			}
			
			if (l.getId().toString().equals("1315267") || l.getId().toString().equals("1315274") || l.getId().toString().equals("1315264")
					|| l.getId().toString().equals("1315274") || l.getId().toString().equals("1315265") || l.getId().toString().equals("1315183")) {
				l.setCapacity(1300.0);
				
			}
			
			if (l.getId().toString().equals("141205") || l.getId().toString().equals("141204") || l.getId().toString().equals("141203")
				|| l.getId().toString().equals("313026") || l.getId().toString().equals("1315176") || l.getId().toString().equals("141201")) {
				l.setCapacity(1300.0);
				
				
			}
			
			if (l.getId().toString().equals("313040") || l.getId().toString().equals("1315184") || l.getId().toString().equals("1315177")
					|| l.getId().toString().equals("141202") || l.getId().toString().equals("313017") || l.getId().toString().equals("313041")
			...
			if (l.getId().toString().equals("19435") || l.getId().toString().equals("1389585") || l.getId().toString().equals("1251378")
					|| l.getId().toString().equals("9921") || l.getId().toString().equals("9904") || l.getId().toString().equals("286687")
			...
			if (l.getId().toString().equals("1387270") || l.getId().toString().equals("953697") || l.getId().toString().equals("953698")) {
				l.setCapacity(1200.0);
